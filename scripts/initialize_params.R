...
params_rmd_path <- here::here("scripts", "set_asf_risk_parameters.Rmd")
...
if (!file.exists(params_file)) {
  stop("Failed to generate parameter file. Check set_asf_risk_parameters.Rmd for errors.")
}
...
cat("- Destination layer date range:", asf_params$begin_date, "to", asf_params$end_date, "\n")
cat("- Risk quantification method:", asf_params$risk_quantification, "\n")
cat("- Countries considered at risk:", asf_params$affected_countries, "\n")
cat("- Years WADS data:", asf_params$years, "\n")
