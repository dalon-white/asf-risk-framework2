# ASF Risk Framework - Improved Hierarchical Chord Diagram
# This script creates an enhanced version of the hierarchical chord diagram
# with removed directional arrows and added data value labels
...
chordDiagram(
  ...
  directional = 0,  # REMOVED DIRECTIONAL ARROWS (changed from 1)
